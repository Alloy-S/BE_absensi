...
class RiwayatPenggajianDetail(db.Model):
    ...
    riwayat_penggajian_id = db.Column(UUID(as_uuid=True), db.ForeignKey('riwayat_penggajian.id', ondelete="CASCADE"), nullable=False)
    ...
    riwayat_penggajian_rincian = db.relationship("RiwayatPenggajianRincian", back_populates="riwayat_penggajian_detail", cascade="all, delete-orphan")