...
class IzinController(Resource):
    ...
    def get(self):
        ...
        result = IzinService.get_list_izin(current_user_id, validated)
    ...
    def post(self):
        ...
        response = IzinService.create_izin(current_user_id, validated)
...
class IzinDetailController(Resource):
    ...
    def get(self, approval_id):
        ...
        result = IzinService.get_detail_approval_izin(current_user_id, approval_id)
    ...
    def delete(self, approval_id):
        ...
        result = IzinService.cancel_approval_izin(current_user_id, approval_id)
